...
#if KIERO_USE_SAFETYHOOK
# include "../safetyhook/safetyhook.hpp"
static safetyhook::InlineHook g_kieroHook{};
#endif
...
#if KIERO_USE_SAFETYHOOK
		g_kieroHook = safetyhook::create_inline(target, _function);
		if (!g_kieroHook)
			return Status::UnknownError;
		*_original = g_kieroHook.original<void*>();
#endif
